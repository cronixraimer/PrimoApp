...
/>
        {/* Calendar has to be little changed or change to fully calendarlist and add agenda into that one 
            Also remake datetimepicker into calendar working on one lib will be easier to deal in the future
            Has to be practiced on agenda making more ui usiablity
        */}
        <Agenda
